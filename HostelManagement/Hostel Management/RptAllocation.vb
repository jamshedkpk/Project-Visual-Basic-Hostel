...
Public Class RptAllocation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hostel_Management.RptAllocation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptAllocation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptAllocation = New RptAllocation()
        rpt.Site = Me.Site
        Return rpt
    End Function
