...
Public Class MessPaymentReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hostel_Management.MessPaymentReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMessPaymentReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MessPaymentReport = New MessPaymentReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
