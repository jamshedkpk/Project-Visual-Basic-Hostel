...
Public Class RptRoomallocation2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hostel_Management.RptRoomallocation2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptRoomallocation2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptRoomallocation2 = New RptRoomallocation2()
        rpt.Site = Me.Site
        Return rpt
    End Function
