...
Public Class RptMessAttendence
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hostel_Management.RptMessAttendence.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMessAttendence
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMessAttendence = New RptMessAttendence()
        rpt.Site = Me.Site
        Return rpt
    End Function
