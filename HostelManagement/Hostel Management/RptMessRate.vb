...
Public Class RptMessRate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hostel_Management.RptMessRate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMessRate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMessRate = New RptMessRate()
        rpt.Site = Me.Site
        Return rpt
    End Function
